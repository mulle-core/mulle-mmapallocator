...
#
# mulle-mmapallocator nodetype: ${MULLE_MMAPALLOCATOR_NODETYPE:-tar}
#
export MULLE_MMAPALLOCATOR_NODETYPE="git"


#
# mulle-mmapallocator url: ${MULLE_MMAPALLOCATOR_URL:-https://github.com/mulle-core/mulle-mmapallocator/archive/${MULLE_TAG}.tar.gz}
#
export MULLE_MMAPALLOCATOR_URL="https://github.com/mulle-core/mulle-mmapallocator.git"


#
# mulle-mmapallocator branch: ${MULLE_MMAPALLOCATOR_BRANCH}
#
export MULLE_MMAPALLOCATOR_BRANCH="prerelease"
...
#
# src/mulle-dlmalloc nodetype: ${MULLE_DLMALLOC_NODETYPE:-tar}
#
export MULLE_DLMALLOC_NODETYPE="git"


#
# src/mulle-dlmalloc url: ${MULLE_DLMALLOC_URL:-https://github.com/mulle-core/mulle-dlmalloc/archive/${MULLE_TAG}.tar.gz}
#
export MULLE_DLMALLOC_URL="https://github.com/mulle-core/mulle-dlmalloc.git"


#
# src/mulle-dlmalloc branch: ${MULLE_DLMALLOC_BRANCH}
#
export MULLE_DLMALLOC_BRANCH="prerelease"
